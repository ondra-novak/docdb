...
template<DocumentDef _ValueDef = RowDocument, IndexType index_type = IndexType::multi>
class IndexView: public ViewBase { // @suppress("Miss copy constructor or assignment operator")
public:
    ...
    public:
        using GenIterator<_ValueDef>::GenIterator;
    ...
    IndexView make_snapshot() const {
        ...
        return IndexView(_kid, _dir, _db->make_snapshot());
    }
